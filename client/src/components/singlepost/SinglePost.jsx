...
export default function SinglePost() {
  ...
  return (
    <div className='singlePost'>
        ...
        {updateMode ? (
          <input type='text' value={title} className='singlePostTitleInput' autoFocus onChange={(e) => setTitle(e.target.value)}></input>
        ):(
        ...
        <div className="singlePostInfo">
          ...
          {
          updateMode ? <textarea className='singlePostDescInput' onChange={(e) => setDesc(e.target.value)}/> :
